 ...
 * @return int
 */
int compute_phase_ij(MODULE* module, GGSWCtParams* params, GGSWSecretKeyDFT* sk_dft, PolyUniv* msg_univ,
                     PolyUnivDFT* msg_univ_dft, PolyBiv* phase_biv, PolyUnivRnX* phase_univ_RnX, PolyUniv* m_skj_univ,
                     PolyUnivDFT* m_skj_univ_dft, int64_t i, int64_t j);
 ...
 * @retval `0` otherwise.
 */
int ggsw_secret_encrypt(MODULE* module, GGSWCtParams* params, GGSWCiphertext* ct_ggsw, GGSWSecretKeyDFT* sk_dft,
                        PolyUniv* msg_univ);
 ...
 * @return int
 */
int add_mult_dft_ggsw(MODULE* module, GLWECtParams* params, PolyBiv* res, VecBiv* as, GGSWSecretKeyDFT* sk_dft);
 ...
 * @retval `0` otherwise.
 */
int ggsw_secret_encrypt_dft(MODULE* module, GGSWCtParams* params, GGSWCiphertextDFT* ct_ggsw_dft,
