 ...
 * @param result The result bivGGSW secret key out of the DFT domain.
 * @param sk_dft A bivGGSW secret key in the DFT domain.
 * 
...
/**
 * @brief Transforms a bivGGSW secret key to a bivGLWE secret key.
 *
 * @param result The result bivGLWE secret key.
 * @param sk_ggsw A bivGGSW secret key
 */
 ...
 *
 * @param module Additionnal information for backend.
 * @param result_dft The result bivGGSW secret key in the DFT domain.
...
/**
 * @brief Transforms a bivGGSW secret key in the DFT domain to a bivGLWE secret key in the DFT domain.
 *
 * @param result_dft The result bivGLWE secret key in the DFT domain.
 * @param sk_ggsw_dft The bivGGSW secret key in the DFT domain.
