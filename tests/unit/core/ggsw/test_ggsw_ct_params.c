...
{
	GLWEParams* params_glwe = new_glwe_params(NBASE, KBASE, KAPPABASE, LBASE, SIGMABASE);
	GGSWParams* params_ggsw = new_ggsw_params(params_glwe, K_TILDEBASE, KAPPA_TILDEBASE, L_TILDEBASE);
